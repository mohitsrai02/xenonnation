...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 31, 2018 at 01:33 PM
...
(14, 'TEST1', 'https://www.test.com', 'https://www.test.com', '', 'android,ios', 'ygdyawhidjsdfgsdjg;jksdgk', 'http://localhost/xenon/img/portfolio/icon/about_us_change_1.png', 'http://localhost/xenon/img/portfolio/icon/8.png'),
(15, 'test2', 'android.com', 'ios.com', 'web.com', 'android,ios,web', 'asjifnjisdngjnsdjnfjkfnjkdnj', 'http://localhost/xenon/img/portfolio/icon/2.jpg', 'http://localhost/xenon/img/portfolio/full/3.jpg'),
(16, 'test3', '', 'ios.com', '', 'ios', 'asnfjksdngjksdnjnfsdnjksdf', 'http://localhost/xenon/img/portfolio/icon/6.jpg', 'http://localhost/xenon/img/portfolio/full/5.jpg'),
...
(18, 'active', 'alskd', 'asjflkas', 'as;ldjasld', 'web,android', 'jsdhkl', 'http://localhost/xenon/img/portfolio/icon/slider1.jpg', 'http://localhost/xenon/img/portfolio/full/slider3.jpg');
...
--
ALTER TABLE `portfolio`
  MODIFY `proj_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
